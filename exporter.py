...
class DocumentExporter:
    ...
    def export_to_markdown(draft_payload: dict, grant_id: str) -> str:
        ...
        print(f"Exported draft to {output_path}")
        return output_path
    ...
    def export_to_pdf(draft_payload: Dict[str, str], grant_id: str) -> str:
        ...
        # Audit/Citation Trace (Hidden in Appendix or Bottom)
        pdf.add_page()
        ...
        print(f"Exported professional PDF to {output_path}")
        return output_path

if __name__ == "__main__":
    # Test export
    sample_payload = {
        "Mission Statement": "Saint Vincent de Paul serves the poor in Pasco by providing food, shelter, and financial assistance. [Source 1]",
        "Financial Need": "We require $50,000 to expand our food pantry operations to serve 200 more families. [Source 2]"
    }
    DocumentExporter.export_to_pdf(sample_payload, "TEST_GRANT_101")
